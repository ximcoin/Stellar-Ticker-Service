...
// ProcessSpecificAssets fetches specified assets from the Horizon public net.
func (c *ScraperConfig) ProcessSpecificAssets(limit int, issuer string, parallelism int, assetQueue chan<- FinalAsset) (numNonTrash int, numTrash int) {
...
func (c *ScraperConfig) FetchAllTrades(
	ctx context.Context,
	...
	trades, err = c.retrieveTrades(ctx, s, l, since, limit)
